...
public class QiniuUtils {
    ...
    public static  final String url = "http://ru4vl1dd1.hb-bkt.clouddn.com/";

    @Value("hCHjWBItT4uAiqiC_0lSVq2zvNzMFtQ8z_i4eGzU")
    private  String accessKey;
    @Value("17IQKuLN1UBSrwX9lo3-YNTm2roI2UxCGfQlERp_")
